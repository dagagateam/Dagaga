...
const resources = {
  ko: {
    translation: {
      ...
      // 메인페이지
      "with_dgg": "<0/>와 함께",
      "communication_rotation": "다국어 소통",
      "info_rotation": "정보 확인",
      "learning_swapcard": "다양한 시나리오를 통해 한국어를 연습하세요",
      "community_swapcard": "다른 학습자들과 모국어로 자유롭게 소통하세요",
      "info_swapcard": "가까운 다문화센터의 다양한 정보를 얻어가세요",
      "learning_navcard": "한국어 연습",
  ...
  zh: {
    translation: {
      ...
      "back_info_list": "返回列表",
      "with_dgg": "与 <0/>一起",
      "communication_rotation": "多语种交流",
      "info_rotation": "信息确认",
      "learning_swapcard": "通过各种剧本练习韩语吧",
      "community_swapcard": "用母语与其他学习者自由交流",
      "info_swapcard": "获取附近多文化中心的各种信息",
      "learning_navcard": "学习",
  ...
  vi: {
    translation: {
      ...
      "swap_learning_title": "Luyện tập tiếng Hàn",
      ...
      "with_dgg": "Cùng với <0/>",
      "communication_rotation": "Giao tiếp đa ngôn ngữ",
      "info_rotation": "Kiểm tra thông tin",
      "learning_swapcard": "Hãy luyện tập tiếng Hàn thông qua nhiều kịch bản đa dạng",
      "community_swapcard": "Hãy giao tiếp tự do với những học viên khác bằng tiếng mẹ đẻ",
      "info_swapcard": "Nhận nhiều thông tin đa dạng từ các trung tâm đa văn hóa gần đó",
