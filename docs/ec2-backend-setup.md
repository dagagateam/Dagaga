...
# 접속
ssh -i <your-key-pair>.pem ubuntu@i14b110.p.ssafy.io
```
...
sudo nano /etc/nginx/sites-available/i14b110.p.ssafy.io
```
...
curl -i http://i14b110.p.ssafy.io/health-check

# HTTPS 요청
curl -i https://i14b110.p.ssafy.io/health-check
```
